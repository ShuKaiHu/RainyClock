...
WeatherKit requires a paid Apple Developer Program team and the app bundle identifier to have the WeatherKit entitlement enabled in Apple Developer / Xcode Signing & Capabilities before real-device requests will succeed.
...
WeatherKit 需要付費 Apple Developer Program team，且 App 的 bundle identifier 已在 Apple Developer / Xcode Signing & Capabilities 啟用 WeatherKit entitlement，真機請求才會成功。
