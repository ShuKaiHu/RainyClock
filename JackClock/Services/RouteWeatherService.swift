...
protocol RouteWeatherService: Sendable {
    func fetchRouteWeather(from homeAddress: String, to workAddress: String, around commuteTime: Date) async throws -> RouteWeatherSnapshot
}
    ...
    func fetchRouteWeather(from homeAddress: String, to workAddress: String, around commuteTime: Date) async throws -> RouteWeatherSnapshot {
        ...
        let segments = rainyInput
            ? [
                ...
                RouteWeatherSegment(name: "Main commute route", condition: .rain, precipitationProbability: 0.72),
            ...
            : [
                ...
                RouteWeatherSegment(name: "Main commute route", condition: .cloudy, precipitationProbability: 0.18),
